...
export default function SettingsPageContent() {
  ...
  useEffect(() => {
    ...
    let url = `${process.env.NEXT_PUBLIC_API_URL}/api/saas/settings?tenantId=${siteConfig.tenantId}`;
  ...
  }, [token, selectedBranch, branchLoading]);
  ...
  if (!selectedBranch) {
    return (
      <div className="text-center py-20">
        Выберите филиал в переключателе справа вверху
      </div>
    );
  }
  ...
  return (
    <div key={selectedBranch?._id} className="max-w-2xl">
